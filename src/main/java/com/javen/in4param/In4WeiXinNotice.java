...
public class In4WeiXinNotice {
	...
	public String toString() {
		return "In4WeiXinNotice [return_code=" + return_code + ", return_msg="
				+ return_msg + ", appid=" + appid + ", mch_id=" + mch_id
				+ ", sub_appid=" + sub_appid + ", device_info=" + device_info
				+ ", nonce_str=" + nonce_str + ", sign=" + sign
				+ ", result_code=" + result_code + ", err_code=" + err_code
				+ ", err_code_des=" + err_code_des + ", openid=" + openid
				+ ", is_subscribe=" + is_subscribe + ", sub_openid="
				+ sub_openid + ", sub_is_subscribe=" + sub_is_subscribe
